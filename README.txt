...
Main.cpp
-Written for CS 529: Fundamentals of Game Development, DigiPen Institute of Technology
-Contains the game loop for the game "Aster'roid-Rage" using engine built
	from ground up using C++

MAT562_NeuralNetwork.py  
-Written for MAT 562: Fuzzy Sets and Logic, DigiPen Institute of Technology
